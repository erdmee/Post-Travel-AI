...
PERSONAS: dict[str, Persona] = {
    "friendly_diary": {
        ...
        "section_rule": "텍스트는 3~5문장의 자연스러운 일기체.",
    },
    "emotional_essay": {
        "system": (
    ...
    "witty": {
        ...
        "section_rule": "텍스트는 3~5문장의 위트 있는 표현. 농담·과장·자기조롱 환영.",
    },
    "concise_log": {
        "system": (
            "당신은 간결한 여행 메모 작가입니다. "
        ...
        "section_rule": "텍스트는 3~5문장. 정보·팁·평가 중심. 명사 위주.",
    },
    "magazine": {
        "system": (
        ...
        "section_rule": "텍스트는 3~5문장의 매거진 톤. 3인칭 어조, 지역 콘텍스트·문화 정보 포함.",
    },
}
...
[구조 규칙]
- 각 섹션은 1~4장의 사진과 그 아래 텍스트로 구성됩니다.
